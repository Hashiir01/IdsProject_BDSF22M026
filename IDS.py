...
<style>
    .stApp {
        background-color: #fbf89f!important;
    }

    .css-1lcbmhc.e1fqkh3o0, .css-1lcbmhc {
        background-color: #e5d478 !important;
    }
...
<style>
    ...
    div[role='radiogroup'] > label[data-selected="true"] {
        background-color: #83d2d4; /* Updated selected color */
        font-weight: bold;
        border-color: #000;
        transform: scale(1.3); /* Enlarge more when selected */
    }
    div[role='radiogroup'] > label > div:first-child {
        display: none; /* Remove the circle */
    }
    .css-1lcbmhc.e1fqkh3o0, .css-1lcbmhc {
        color: white !important; /* Set sidebar text color to white */
    }
</style>
"""
st.markdown(inline_radio_css, unsafe_allow_html=True)
...
if page=="Overview 📝":
    ...
    st.write("**Shape Of Dataset** : (419,22)")
    st.subheader("**Total Reords** : 419")
    ...
    features = ['Age', 'Experience', 'Income', 'Fairness', 'Job Mobility', 'Reward of Ideas']
    X = data[features]
